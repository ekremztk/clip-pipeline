    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="ml-[260px]">
        ...
        <main className="p-6 max-w-2xl">
          <h1 className="text-2xl font-bold tracking-tight text-[#171717] mb-6">Wiederholen</h1>

          {loading ? (
            <div className="text-sm text-[#a3a3a3]">Laden...</div>
          ) : cards.length === 0 ? (
            <div className="border border-dashed border-[#e5e5e5] rounded-lg p-8 text-center">
              ...
              <p className="text-sm text-[#a3a3a3]">Keine Karten fällig</p>
              <p className="text-xs text-[#a3a3a3] mt-1">Komm später zurück oder lerne neue Themen</p>
            </div>
          ) : cards.length < 4 ? (
            <div className="border border-dashed border-[#e5e5e5] rounded-lg p-8 text-center">
            ...
            <div className="border border-[#e5e5e5] rounded-lg p-8 text-center">
              ...
              <p className="text-sm text-[#737373] mt-2">
                {score.correct === score.total ? 'Perfekt!' :
                 score.correct >= score.total * 0.8 ? 'Sehr gut!' : 'Weiter üben!'}
              </p>
            </div>
          ) : (
