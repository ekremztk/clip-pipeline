...
export default function ChannelSettingsPage() {
    ...
    const dna = selectedChannel?.channel_dna;
        ...
        <div className="flex h-[calc(100vh-64px)] overflow-hidden bg-[#09090b]">
            ...
            <div className="w-[360px] flex-shrink-0 border-r border-white/[0.06] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-3 space-y-1.5">
                    ...
                    transition-all duration-200`}>
                                        {(ch.name || ch.id).charAt(0).toUpperCase()}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-2 mb-0.5">
                                            <p className="font-medium text-white text-sm truncate">{ch.name || ch.id}</p>
                ...
                {selectedChannel ? (
                    ...
                    >
                        ...
                        <div className="flex items-start justify-between mb-8">
                            <div>
                                <h2 className="text-2xl font-bold text-white tracking-tight">{selectedChannel.name || selectedChannel.id}</h2>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {dna.tone && (
                                        <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-4">
                                            ...
                                            <div className="flex flex-wrap gap-1.5">
                                                {(Array.isArray(dna.tone) ? dna.tone : [dna.tone]).map((t: string, i: number) => (
                                                    <span key={i} className="text-xs px-2.5 py-1 bg-violet-500/10 text-violet-300 border border-violet-500/20 rounded-lg">{t}</span>
                                                ))}
                                            </div>
                                        </div>
                                    )}
                                    {dna.humor_profile && (
                                        <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-4">
                                            ...
                                            <div className="flex flex-wrap gap-1.5">
                                                {(Array.isArray(dna.humor_profile) ? dna.humor_profile : [dna.humor_profile]).map((h: string, i: number) => (
                                                    <span key={i} className="text-xs px-2.5 py-1 bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 rounded-lg">{h}</span>
                                                ))}
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {dna.content_pillars && (
                                        <div className="col-span-2 bg-white/[0.03] border border-white/[0.06] rounded-xl p-4">
                                            ...
                                            <div className="flex flex-wrap gap-1.5">
                                                {(Array.isArray(dna.content_pillars) ? dna.content_pillars : [dna.content_pillars]).map((p: string, i: number) => (
                                                    <span key={i} className="text-xs px-2.5 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-lg">{p}</span>
                                                ))}
                                            </div>
                                        </div>
                                    )}
