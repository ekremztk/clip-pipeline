      ...
      >
        ...
        <header className="h-16 bg-[#000000] border-b border-white/[0.06] flex items-center justify-between px-6 sticky top-0 z-40">
          <div className="flex items-center">
            ...
            <button className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#7c3aed] bg-transparent text-sm font-medium hover:bg-[#7c3aed]/10 transition-colors">
              <span className="text-[#e5e5e5]">Speedy Cast</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  >
                    ...
                    <div className="flex items-end justify-between">
                      <div className="text-3xl font-bold"><CountUp value={1284} /></div>
                      <div className="flex items-center text-green-500 text-xs font-medium bg-green-500/10 px-2 py-0.5 rounded">
                        <TrendingUp className="w-3 h-3 mr-1" />
                        +12%
                      </div>
                    </div>
                    <div className="text-[#6b7280] text-xs mt-2">clips produced</div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="flex items-end justify-between">
                      <div className="text-3xl font-bold"><CountUp value={4.2} isFloat={true} suffix="M" /></div>
                      <div className="flex items-center text-green-500 text-xs font-medium bg-green-500/10 px-2 py-0.5 rounded">
                        <TrendingUp className="w-3 h-3 mr-1" />
                        +8.4%
                      </div>
                    </div>
                    <div className="text-[#6b7280] text-xs mt-2">across platforms</div>
                  </motion.div>
                  ...
                  >
                    <div>
                      ...
                      <div className="text-3xl font-bold"><CountUp value={86} /><span className="text-lg text-[#6b7280]">%</span></div>
                    ...
                    <div className="relative w-14 h-14">
                      <svg className="w-full h-full transform -rotate-90">
                        ...
                        <circle
                          ...
                          stroke="#06b6d4"
                          strokeWidth="6"
                          strokeDasharray={`${(86 / 100) * 150} 150`}
                          strokeLinecap="round"
                        />
                      </svg>
                    </div>
                  ...
                  >
                    ...
                    <div className="text-3xl font-bold">$<CountUp value={42.50} isFloat={true} /></div>
                  ...
                  >
                    <div className="p-4 border-b border-white/[0.06] flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-sm">Joe Rogan Experience #2054 - Elon Musk</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className="text-xs text-[#6b7280]">Extracting Audio...</span>
                        <span className="px-2.5 py-1 rounded bg-[#7c3aed]/10 text-[#7c3aed] text-xs font-medium border border-[#7c3aed]/20">
                          Running
                        </span>
                      </div>
                    </div>
                    <div className="w-full h-1 bg-[#1a1a1a]">
                      <div className="h-full bg-[#7c3aed] w-[45%] relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        <div className="absolute top-2 right-2 flex items-center gap-1 bg-[#0a0a0a]/80 backdrop-blur px-1.5 py-0.5 rounded text-[10px] font-bold text-orange-400 border border-orange-500/20 z-10">
                          88
                        </div>
                        ...
                        <h3 className="text-sm font-medium line-clamp-1 mb-1 group-hover:text-[#7c3aed] transition-colors">Elon's Mars Vision</h3>
                        <p className="text-xs text-[#6b7280] line-clamp-2 italic">"The reality is we need to become a multi-planetary species before..."</p>
                      </motion.div>
                      ...
                      <motion.div
                        ...
                        className="bg-[#0d0d0d] border border-white/[0.06] rounded-lg p-3 group hover:bg-white/[0.02] transition-colors cursor-pointer relative overflow-hidden"
                      >
                        <div className="absolute top-2 right-2 flex items-center gap-1 bg-[#0a0a0a]/80 backdrop-blur px-1.5 py-0.5 rounded text-[10px] font-bold text-green-400 border border-green-500/20 z-10">
                          92
                        </div>
                        <div className="aspect-video bg-[#1a1a1a] rounded mb-3 relative overflow-hidden">
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/40">
                        ...
                        <h3 className="text-sm font-medium line-clamp-1 mb-1 group-hover:text-[#7c3aed] transition-colors">AI Timelines</h3>
                        <p className="text-xs text-[#6b7280] line-clamp-2 italic">"AGI will probably be smarter than all humans combined by..."</p>
                      </motion.div>
                    </div>
                  </div>
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[#0d0d0d] border border-white/[0.06] rounded-lg p-6 space-y-5">
                    ...
                    <div>
                      ...
                      <select className="w-full bg-[#1a1a1a] border border-white/[0.1] rounded px-3 py-2 text-sm text-white focus:outline-none focus:border-[#7c3aed] transition-colors appearance-none">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`w-full py-3 rounded text-sm font-semibold transition-all ${file && title
                ...
                <div className="mt-12">
                  ...
                  <div className="space-y-2">
                    {[
                      { title: "Huberman Lab #105 - David Goggins", status: "Done", time: "2 hours ago" },
                      { title: "Lex Fridman - Dopamine Mastery", status: "Error", time: "Yesterday" }
                    ].map((job, i) => (
                      <motion.div
                        key={i}
                        initial={{ opacity: 0, x: -12 }}
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          <span className="text-xs text-[#6b7280]">{job.time}</span>
                          {job.status === "Done" ? (
